...
public class Tuple9<T0, T1, T2, T3, T4, T5, T6, T7, T8> implements Tuple, Comparable<Tuple9<T0, T1, T2, T3, T4, T5, T6, T7, T8>> {
    ...
    public static <A, V0 extends A, V1 extends A, V2 extends A, V3 extends A, V4 extends A, V5 extends A, V6 extends A,
            V7 extends A, V8 extends A>
    Tuple9<V0, V1, V2, V3, V4, V5, V6, V7, V8> fromArray(A[] values) {
    ...
    public static <A, V0 extends A, V1 extends A, V2 extends A, V3 extends A, V4 extends A, V5 extends A, V6 extends A,
            V7 extends A, V8 extends A>
    Tuple9<V0, V1, V2, V3, V4, V5, V6, V7, V8> fromIterator(Iterator<A> iterator) {
    ...
    public void unfold(Consumer9<T0, T1, T2, T3, T4, T5, T6, T7, T8> valueConsumer) {
        valueConsumer.accept(getValue0(), getValue1(), getValue2(), getValue3(), getValue4(), getValue5(),
                getValue6(), getValue7(), getValue8());
    }

    public <R> R unfoldResult(Function9<T0, T1, T2, T3, T4, T5, T6, T7, T8, R> valueFunction) {
    ...
    @SuppressWarnings("unchecked")
    private static final Comparator<Tuple9> comparator =
            Comparator.<Tuple9, Comparable<Object>>comparing(tuple -> (Comparable) tuple.getValue0(), Tuple1.nullComparator)
            .thenComparing(
            Comparator.<Tuple9, Comparable<Object>>comparing(tuple -> (Comparable) tuple.getValue1(), Tuple1.nullComparator))
            .thenComparing(
            Comparator.<Tuple9, Comparable<Object>>comparing(tuple -> (Comparable) tuple.getValue2(), Tuple1.nullComparator))
            .thenComparing(
            Comparator.<Tuple9, Comparable<Object>>comparing(tuple -> (Comparable) tuple.getValue3(), Tuple1.nullComparator))
            .thenComparing(
            Comparator.<Tuple9, Comparable<Object>>comparing(tuple -> (Comparable) tuple.getValue4(), Tuple1.nullComparator))
            .thenComparing(
            Comparator.<Tuple9, Comparable<Object>>comparing(tuple -> (Comparable) tuple.getValue5(), Tuple1.nullComparator))
            .thenComparing(
            Comparator.<Tuple9, Comparable<Object>>comparing(tuple -> (Comparable) tuple.getValue6(), Tuple1.nullComparator)
            .thenComparing(
            Comparator.<Tuple9, Comparable<Object>>comparing(tuple -> (Comparable) tuple.getValue7(), Tuple1.nullComparator))
            .thenComparing(
            Comparator.<Tuple9, Comparable<Object>>comparing(tuple -> (Comparable) tuple.getValue8(), Tuple1.nullComparator)));

    @SuppressWarnings("unchecked")
    @Override public int compareTo(Tuple9<T0, T1, T2, T3, T4, T5, T6, T7, T8> o) {
    ...
    @Override
    public int hashCode() {
        return Tuple.deepHash(getValue0(), getValue1(), getValue2(), getValue3(), getValue4(), getValue5(), getValue6(),
                getValue7(), getValue8());
    }
